...
class WeeklyChartData {
  ...
  factory WeeklyChartData.fromWeeklySummary(Map<int, double> dailyData) {
...
class YearlyChartData {
  ...
  factory YearlyChartData.fromYearlySummary(Map<int, double> monthlyData) {
    final monthNames = [
      'Jan',
      'Feb',
      'Mar',
